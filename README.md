...
## 🚀 Features
* **Interactive Navigation Menu:** Seamlessly switch between creating entries, searching records, updating details, viewing help, and exiting using a continuous loop.
...
* 🔮 **Custom Storage:** Option to save data in custom, user-named `.py` database files.

## 🛠️ Project Structure
```text
registrarY/
├── registrarX.py      # Main CLI application script
